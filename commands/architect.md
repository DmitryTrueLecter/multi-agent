...
2. `${CLAUDE_PROJECT_DIR}/.claude/config.yml` — project settings and conventions
3. Scan `${CLAUDE_PROJECT_DIR}/.claude/areas/` — each subdirectory is an area with its `area.yml`
