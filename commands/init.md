---
description: "Initialize dma project-local scaffolding (config.yml, arch.yml, Justfile, the analyst's product/ templates) into .claude/dma/. Idempotent — never overwrites existing files."
---
