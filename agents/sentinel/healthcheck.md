...
↻ HC-FS-002 — legacy layout migrated to .claude/dma/ (config.yml, areas/, devops/) — manual: update root Justfile import to '.claude/dma/Justfile'
